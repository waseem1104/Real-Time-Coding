...
// CHAT PRIVATE
exports.Message.belongsTo(exports.User, {through: exports.Message, foreignKey: "userid"});
exports.Message.belongsTo(exports.User, {through: exports.Message, foreignKey: "advisor"});